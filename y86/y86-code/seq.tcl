...
set fontSize [expr 10 * [flagVal "f" 18]]
set codeFontSize [expr 10 * [flagVal "c" 18]]
set labFontSize [expr 10 * [flagVal "l" 18]]
set bigFontSize [expr 10 * [flagVal "b" 24]]
...
set codeFont "*-courier-bold-r-normal--*-$codeFontSize-*-*-*-*-*-*"
